...
namespace AreebaWoocommerceGateway\Client\Http;

use AreebaWoocommerceGateway\Client\Client;
use AreebaWoocommerceGateway\Client\Http\Exception\ClientException;

/**
 * Class CurlClient
 *
 * @package AreebaWoocommerceGateway\Client\Http
 */
