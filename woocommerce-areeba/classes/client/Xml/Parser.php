...
namespace AreebaWoocommerceGateway\Client\Xml;

use AreebaWoocommerceGateway\Client\Callback\ChargebackData;
use AreebaWoocommerceGateway\Client\Callback\ChargebackReversalData;
use AreebaWoocommerceGateway\Client\Data\Customer;
use AreebaWoocommerceGateway\Client\Data\Result\CreditcardData;
use AreebaWoocommerceGateway\Client\Data\Result\IbanData;
use AreebaWoocommerceGateway\Client\Data\Result\PhoneData;
use AreebaWoocommerceGateway\Client\Data\Result\ResultData;
use AreebaWoocommerceGateway\Client\Data\Result\WalletData;
use AreebaWoocommerceGateway\Client\Exception\ClientException;
use AreebaWoocommerceGateway\Client\Schedule\ScheduleResult;
use AreebaWoocommerceGateway\Client\Exception\InvalidValueException;
use AreebaWoocommerceGateway\Client\Schedule\ScheduleError;
use AreebaWoocommerceGateway\Client\StatusApi\StatusResult;
use AreebaWoocommerceGateway\Client\Transaction\Error;
use AreebaWoocommerceGateway\Client\Transaction\Result;
use AreebaWoocommerceGateway\Client\Callback\Result as CallbackResult;

/**
 * Class Parser
 *
 * @package AreebaWoocommerceGateway\Client\Xml
 */
class Parser {
