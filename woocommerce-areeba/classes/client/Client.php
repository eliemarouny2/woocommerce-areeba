...
namespace AreebaWoocommerceGateway\Client;

use AreebaWoocommerceGateway\Client\CustomerProfile\CustomerData;
use AreebaWoocommerceGateway\Client\CustomerProfile\DeleteProfileResponse;
use AreebaWoocommerceGateway\Client\CustomerProfile\GetProfileResponse;
use AreebaWoocommerceGateway\Client\CustomerProfile\PaymentInstrument;
use AreebaWoocommerceGateway\Client\CustomerProfile\UpdateProfileResponse;
use AreebaWoocommerceGateway\Client\Json\ErrorResponse;
use AreebaWoocommerceGateway\Client\Exception\RateLimitException;
use AreebaWoocommerceGateway\Client\Schedule\ScheduleData;
use AreebaWoocommerceGateway\Client\Exception\ClientException;
use AreebaWoocommerceGateway\Client\Exception\InvalidValueException;
use AreebaWoocommerceGateway\Client\Exception\TimeoutException;
use AreebaWoocommerceGateway\Client\Http\CurlClient;
use AreebaWoocommerceGateway\Client\Http\Response;
use AreebaWoocommerceGateway\Client\StatusApi\StatusRequestData;
use AreebaWoocommerceGateway\Client\Transaction\Base\AbstractTransaction;
use AreebaWoocommerceGateway\Client\Transaction\Capture;
use AreebaWoocommerceGateway\Client\Transaction\Debit;
use AreebaWoocommerceGateway\Client\Transaction\Deregister;
use AreebaWoocommerceGateway\Client\Transaction\Payout;
use AreebaWoocommerceGateway\Client\Transaction\Preauthorize;
use AreebaWoocommerceGateway\Client\Transaction\Refund;
use AreebaWoocommerceGateway\Client\Transaction\Register;
use AreebaWoocommerceGateway\Client\Transaction\Result;
use AreebaWoocommerceGateway\Client\Transaction\VoidTransaction;
use AreebaWoocommerceGateway\Client\Xml\Generator;
use AreebaWoocommerceGateway\Client\Xml\Parser;
 ...
 * Class Client
 *
 * @package AreebaWoocommerceGateway\Client
 */
class Client {
     ...
     *
     * @param \AreebaWoocommerceGateway\Client\Transaction\VoidTransaction $transactionData
     *
     * @return Result
     * @throws ClientException
     * @throws InvalidValueException
